          ...
          {message.role === "assistant" && 
            <div className={`chatMessage chatGPT`}>
              ...
              <div className={"message"}>
                  ...
                  <div children={message.content && message.cleanedGPTResponse ? message.cleanedGPTResponse : message.content}/>
              </div>
            
            </div>
          }
          { message.role === "user" && 
            <div className={`chatMessage ${!!message.success && (message.success === "RIGHT" ? "success" : "error")}`}>
              <div className={`avatar user`}/>
              <div className={"message "}>
                <div children={message.content && message.content}/>
                {
                  message.errorMessage &&
                  <div className='explanation'>{message.errorMessage}</div>
                }
              </div>
            </div>
          }
